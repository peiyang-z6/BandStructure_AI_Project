...
def test_brain_invoker_defaults_resolve_to_latest_formal_artifacts():
    ...
    expected = {
        "encoder_path": "artifacts/models/aflow_noleak_v7_60k_seed42/ssl_mbm_pretrained.keras",
        "weights_path": "artifacts/models/aflow_noleak_v7_60k_seed42/finetuned.weights.h5",
        "norm_path": "artifacts/models/aflow_noleak_v7_60k_seed42/ssl_mbm_norm_stats.json",
        "config_path": "artifacts/models/aflow_noleak_v7_60k_seed42/finetuned_config.json",
    }
...
def test_latest_model_smoke_targets_v7_60k_paths():
    text = (ROOT / "tests" / "smoke_latest_model.py").read_text(encoding="utf-8")
    assert "aflow_noleak_v7_60k_seed42" in text
    assert "ood_tensors_v7_60000_seed42" in text
...
def test_gui_tsne_path_targets_latest_formal_experiment():
    ...
    expected = '"aflow_noleak_v7_60k_seed42" / "latent_tsne_spacegroups.png"'
